...
public enum Traits
{
    ...
    Hoarder = 537,
    /// <summary>This trait changes its effect based on this units highest stat. Violent(Str): 5% Max HP Attack on 4turn CD; Excitable(Dex): +1 Attack for 1turn/Level; Vor: Hyper(Agi): +2 movement, +10% dodge above 50%hp; Whimsical(Will): ; Entropic(Mnd): Dmg spells deal 20% of target's mnd; Valient(End): damage over 10% current health, excess is reduced by by 50%.; Gloomy(Stm): Ldr:</summary>
    Multifaceted = 538,
